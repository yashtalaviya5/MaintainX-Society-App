...
Complaint Management: Track, assign, and resolve resident complaints in real-time. 
...
Maintenance Dues: Check current and past maintenance bills.
Meeting Alerts: Receive notifications for scheduled society meetings.
...
Firebase Authentication: Provides secure login and registration for residents and administrators.
Cloud Firestore: A real-time NoSQL database used to synchronize society data, complaints, and billing across all devices.


3. Design & Architecture
Material 3 (M3): The latest Google design system used for a modern, high-contrast User Interface.
Service-Oriented Architecture: Uses modular services (e.g., AuthService, NotificationService) for clean, maintainable code.
Dark Mode Support: Context-aware theme system using ChangeNotifier.

4. Development & Deployment Tools
Git & GitHub: Used for version control, collaboration, and repository hosting.
Android Studio / VS Code: Integrated Development Environments (IDEs) used for coding.
Flutter CLI: Used for project management (building APKs/AABs, cleaning, and testing).
